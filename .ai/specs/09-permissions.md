...
Ver detalle completo en [backend `05-roles-permissions.md`](https://github.com/fenix-core/optibienestar-360-backend/blob/main/.ai/specs/05-roles-permissions.md).
...
- [Backend `05-roles-permissions.md`](https://github.com/fenix-core/optibienestar-360-backend/blob/main/.ai/specs/05-roles-permissions.md)
