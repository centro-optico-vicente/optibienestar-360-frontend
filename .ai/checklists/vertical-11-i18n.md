...
- [ ] [P1/C1] `i18n/locales/es.json` poblado (fuente de verdad de UI) + `en.json` con las **mismas keys**. Estructura por dominio (`common`, `auth`, `members`, `memberships`, `payments`, `validator`, `errors`, …) — ya esbozada en el spec. **Parcial 2026-07-13:** poblados `common`, `validation`, `auth`, `security` (145 keys, paridad es/en verificada); el resto de dominios se puebla al retrofit de cada vertical.
