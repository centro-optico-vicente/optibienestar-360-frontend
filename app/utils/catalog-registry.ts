...
export const CATALOGS: CatalogDef[] = [
  ...
  {
    key: 'professions',
    basePath: '/v1/admin/catalogs/professions',
    viewPermission: 'PROFESSION_VIEW_ALL',
    createPermission: 'PROFESSION_CREATE',
    updatePermission: 'PROFESSION_UPDATE',
    deletePermission: 'PROFESSION_DELETE',
    label: 'Profesiones',
    labelSingular: 'Profesión',
    labelKey: 'catalogs.registry.professions.label',
    labelSingularKey: 'catalogs.registry.professions.labelSingular',
    icon: 'i-lucide-stethoscope',
    codeField: 'code',
    auditEntityKey: 'profession',
    auditPermission: 'PROFESSION_RECORD_AUDIT_VIEW',
    auditReportPermission: 'PROFESSION_REPORT_AUDIT_VIEW',
    fields: [
