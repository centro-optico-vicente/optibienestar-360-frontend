...
<template>
  <div class="space-y-5">
    ...
    <div class="bg-white rounded-2xl border border-prohealth-100 overflow-hidden flex flex-col h-[calc(100vh-19rem)] min-h-[20rem]">
      <div v-if="loading" class="flex-1 flex items-center justify-center text-prohealth-500">
        <UIcon name="i-lucide-loader-2" class="w-6 h-6 animate-spin" />
      </div>
      <div v-else-if="data.length === 0" class="flex-1 flex flex-col items-center justify-center text-prohealth-500">
        <UIcon name="i-lucide-file-text" class="w-8 h-8 mb-2 text-prohealth-300" />
