...
export const PERMISSIONS = [
  ...
  'PROFESSION_VIEW_ALL', 'PROFESSION_CREATE', 'PROFESSION_UPDATE', 'PROFESSION_DELETE',
  ...
  // Granular catalog audit permissions (V77) — bitácora de cambios/reportes por catálogo.
  'COUNTRY_RECORD_AUDIT_VIEW', 'COUNTRY_REPORT_AUDIT_VIEW',
  'STATE_RECORD_AUDIT_VIEW', 'STATE_REPORT_AUDIT_VIEW',
  'CITY_RECORD_AUDIT_VIEW', 'CITY_REPORT_AUDIT_VIEW',
  'GENDER_RECORD_AUDIT_VIEW', 'GENDER_REPORT_AUDIT_VIEW',
  'DOCUMENT_TYPE_RECORD_AUDIT_VIEW', 'DOCUMENT_TYPE_REPORT_AUDIT_VIEW',
  'MARITAL_STATUS_RECORD_AUDIT_VIEW', 'MARITAL_STATUS_REPORT_AUDIT_VIEW',
  'OCCUPATION_RECORD_AUDIT_VIEW', 'OCCUPATION_REPORT_AUDIT_VIEW',
  'PROFESSION_RECORD_AUDIT_VIEW', 'PROFESSION_REPORT_AUDIT_VIEW',
  'SERVICE_CATEGORY_RECORD_AUDIT_VIEW', 'SERVICE_CATEGORY_REPORT_AUDIT_VIEW',
  'PROMOTER_TYPE_RECORD_AUDIT_VIEW', 'PROMOTER_TYPE_REPORT_AUDIT_VIEW',
  ...
  'COLLECTION_APPROVE',
  'COLLECTION_REJECT',
  'COLLECTION_CREATE_OWN',
  'COLLECTION_DELETE_OWN',
  'COLLECTION_CREATE_DOWNLINE',
  'COLLECTION_APPROVE_DOWNLINE',
  'COLLECTION_REJECT_DOWNLINE',
  'COLLECTION_DELETE_DOWNLINE',
  ...
  'PROMOTER_RANK_VIEW_ALL',
  'PROMOTER_RANK_CREATE',
  'PROMOTER_RANK_UPDATE',
  'PROMOTER_RANK_DELETE',
  ...
  'HIERARCHY_OVERRIDE_TIER_VIEW_ALL',
  'HIERARCHY_OVERRIDE_TIER_CREATE',
  ...
  'PROMOTER_RANK_RECORD_AUDIT_VIEW',
  ...
  'PROMOTER_RANK_REPORT_AUDIT_VIEW',
  ...
  // PAYMENT_CATALOG (V119, hub plan payments-unification) — bank/payment_category/
  // payment_method admin catalogs, 6-permission standard (VIEW_ALL/CREATE/UPDATE/
  // DELETE + RECORD_AUDIT_VIEW/REPORT_AUDIT_VIEW), same shape V73 uses for country/gender/etc.
  ...
  // TERMS & CONDITIONS (V139) — versioned T&C per role (AFILIADO/PROMOTOR/ALIADO).
  'TERMS_VIEW_ALL',
  'TERMS_CREATE',
  'TERMS_UPDATE',
  'TERMS_RECORD_AUDIT_VIEW',
] as const
